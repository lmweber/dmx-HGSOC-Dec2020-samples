...
mkdir -p outputs/vireo_1000Genomes_threeUTRs/18389X3

vireo -c outputs/cellSNP_1000Genomes_threeUTRs/18389X3 -N 2 -o outputs/vireo_1000Genomes_threeUTRs/18389X3 --randSeed=123
