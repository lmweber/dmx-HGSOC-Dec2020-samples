...
mkdir -p outputs/vireo_1000Genomes_threeUTRs/18389X2

vireo -c outputs/cellSNP_1000Genomes_threeUTRs/18389X2 -N 2 -o outputs/vireo_1000Genomes_threeUTRs/18389X2 --randSeed=123
